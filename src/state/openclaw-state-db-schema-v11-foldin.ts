...
export const FOLDED_SINGLETON_STATE_TABLES_V11 = [
  "skill_curator_state",
  "update_check_state",
...
export function migrateSingletonStateFoldInV11(db: DatabaseSync, previousVersion: number): boolean {
  ...
  let dropped = false;
  for (const tableName of FOLDED_SINGLETON_STATE_TABLES_V11) {
