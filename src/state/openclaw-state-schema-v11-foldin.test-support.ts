// Recreate the exact v10 table contracts so migration and pinned-reader proofs
// can project a current database through the documented 11→10 downgrade.
const FOLDED_STATE_TABLES_V11_FIXTURE_SQL = `
...
export const STATE_SCHEMA_11_TO_10_DOWNGRADE_SQL = `${FOLDED_STATE_TABLES_V11_FIXTURE_SQL}
