// Pure workspace identity derivation (canonical path + sha256 key). Kept free
// of database imports so plugin doctor contracts can reach identity helpers
// without statically pulling kysely into their import closure.
...
export function canonicalizeWorkspaceIdentityPath(workspaceDir: string): string {
